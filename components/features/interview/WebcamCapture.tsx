<<<<<<< HEAD
// Proxy re-export to satisfy imports using `@/components/features/interview/WebcamCapture`
export { default } from '@/components/components/features/interview/WebcamCapture';
=======
'use client';
